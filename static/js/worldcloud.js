!function (t, e) {
    ...
    return function (t) {
        ...
        n.linearMap = function (t, e, r, n) {
            ...
            var r = Math.log, n = Math.LN10, a = Math.floor(r(t[1] - t[0]) / n),
                i = Math.round(r(Math.abs(e[1] - e[0])) / n);
        ...
        n.prototype = {
            constructor: n, union: function (t) {
                ...
                var e = this, r = e.x, n = e.x + e.width, a = e.y, i = e.y + e.height, o = t.x, u = t.x + t.width,
                    c = t.y, l = t.y + t.height;
        ...
        var r = "undefined" == typeof Float32Array ? Array : Float32Array, n = {
            create: function () {
                ...
                var n = e[0] * r[0] + e[2] * r[1], a = e[1] * r[0] + e[3] * r[1], i = e[0] * r[2] + e[2] * r[3],
                    o = e[1] * r[2] + e[3] * r[3], u = e[0] * r[4] + e[2] * r[5] + e[4],
                    c = e[1] * r[4] + e[3] * r[5] + e[5];
        ...
        window.setImmediate || (window.setImmediate = function () {
            ...
            var i = function () {
                ...
                if (i) {
                    ...
                    var l, s, f, h, d, g, m, p = n.gridSize, v = p - n.maskGapWidth,
                        y = Math.abs(n.maxRotation - n.minRotation), w = Math.min(n.maxRotation, n.minRotation),
                        x = n.rotationStep;
                    switch (n.color) {
                        case"random-dark":
                            m = function () {
                    ...
                    var b, S = !1, C = [], I = function (t) {
                        ...
                        var s = l.measureText(t).width / u,
                            f = Math.max(i * u, l.measureText("m").width, l.measureText("锛�").width) / u, h = s + 2 * f,
                            d = 3 * f, g = Math.ceil(h / p), m = Math.ceil(d / p);
                        h = g * p, d = m * p;
                        var v = -s / 2, y = .4 * -f,
                            w = Math.ceil((h * Math.abs(Math.sin(r)) + d * Math.abs(Math.cos(r))) / p),
                            x = Math.ceil((h * Math.abs(Math.cos(r)) + d * Math.abs(Math.sin(r))) / p), M = x * p,
                            b = w * p;
                        ...
                        if (q("wordcloudstart", !0)) {
                            ...
                            if (!e.getContext || n.clearCanvas) for (t.forEach(function (t) {
                                ...
                                var c = u.getImageData(0, 0, 1, 1).data,
                                    m = e.getContext("2d").getImageData(0, 0, s * p, f * p).data;
                                a = s;
        ...
        a.registerLayout(function (t, e) {
            t.eachSeriesByType("wordCloud", function (r) {
                var u = i.getLayoutRect(r.getBoxLayoutParams(), {width: e.getWidth(), height: e.getHeight()}),
                    c = r.getData(), l = document.createElement("canvas");
